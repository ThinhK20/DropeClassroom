...
function ClassRoomCard({ classroom }: ClassroomCardProps) {
  ...
  const pathClassRoom = "/c/" + classroom.classId;
    ...
    >
      ...
      <div className="relative flex flex-col w-full rounded-xl">
        ...
        <div className="absolute top-0 left-0 aspect-square w-3/4 h-2/5 flex flex-col justify-between z-[10]">
          <div className="overflow-hidden flex flex-col w-full text-white hover:underline-offset-1 hover:underline cursor-pointer " onClick={() => {navigate(pathClassRoom)}}>
            <h1 className="text-2xl font-medium truncate pl-4">
              {classroom.name}
            </h1>
