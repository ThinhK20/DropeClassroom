...
function FunctionButton() {
  ...
  return (
    <>
      <button className="regular-20 text-black/50 px-2 py-2 rounded-full hover:bg-gray-500/10 hover:text-black/70 cursor-pointer -ml-3 hidden md:block focus:bg-gray-500/40"
