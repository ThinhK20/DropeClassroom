    ...
    const modifiedData = {
      ...
      studentAssignment: (
        groupStudentAssignmentsByStudentId.find(
          (x) => x.studentId! === (currentUserClassroom as UserClassRoom)._id
  ...
  return (
    <div className="pt-2">
      ...
      >
        ...
        >
          <form className="flex flex-col justify-center items-center w-[80%] pb-8">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900 truncate">
                          {props.gradeReview?.studentAssignment?.studentId
                            ?.userId?.username ||
                            currentUserClassroom?.userId?.username}
                        </p>
            ...
            {props.gradeReview && (
              <CommentBox gradeReview={props.gradeReview} />
            )}
          </form>
        </Box>
      </Dialog>
