          ...
          <TableBody>
            {gradeReviews.map((gradeReview, index) => (
              <TableRow key={gradeReview._id}>
                ...
                <TableCell>
                  {gradeReview.studentAssignment?.assignmentId?.assignmentName}
                </TableCell>
                <TableCell>
                  {gradeReview.studentAssignment?.studentId?.userId?.username}
                </TableCell>
                ...
                <TableCell>
                  {gradeReview.status === AssignmentStatusEnum.Completed && (
                    <Chip
                  ...
                  {gradeReview.status === AssignmentStatusEnum.Pending && (
                    <Chip
                      label={gradeReview.status}
                      color="warning"
                      variant="filled"
                  ...
                  {gradeReview.status === AssignmentStatusEnum.Dismissed && (
                    <Chip
                      label={gradeReview.status}
                      color="error"
                      variant="filled"
